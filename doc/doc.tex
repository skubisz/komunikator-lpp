...
Wybranie z listy zarejestrowanego użytkownika spowoduje wyświetlenie jego dokładnych danych osobowych na liście poniżej i wyświetlenie jego kontaktów na liście po prawej stronie. 
...
\end{itemize}
Nie gwarantujemy jednak, że przy innej wersji zintegrowanego środowiska programistycznego, a w szczególności innej wersji kompilatora języka C\# Serwer eTalk będzie działał poprawnie.
...
\begin{itemize}
    ...
    \item[--] \texttt{Serwer}.
\end{itemize}
Dokładny opis wszystkich metod zawartych we wszystkich klasach znajduje się w dokumentacji
MSDN wygenerowanej programem NDoc.
